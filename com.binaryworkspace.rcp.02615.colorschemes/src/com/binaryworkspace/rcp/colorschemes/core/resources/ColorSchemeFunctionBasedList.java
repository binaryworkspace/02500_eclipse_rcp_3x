 ...
 * schemes. A color sample based on a Polynomial Least Squares Regression Fit
 * from a predefined gradient will be return when a percentage value on the
 * Decimal interval [0, 1] is provided.
 * <p>
 ...
 * 
 */
public final class ColorSchemeFunctionBasedList {

	private ColorSchemeFunctionBasedList() {
		// Hidden Constructor
	}
	...
	public static List<Integer> getOctectColor(float percentage) {
		return getIntegerListFromArray(ColorSchemeFunctionBasedArray.getOctectVisibleSpectrum(percentage));
	}
	...
	public List<Integer> getOctectColorWithAlpha(float percentage, int a) {
		return getIntegerListFromArray(ColorSchemeFunctionBasedArray.getOctectVisibleSpectrumWithAlpha(percentage, a));
	}
	...
	public List<Float> getDecimalColor(float percentage) {
		return getFloatListFromArray(ColorSchemeFunctionBasedArray.getDecimalVisibleSpectrum(percentage));
	}
	...
	public List<Float> getDecimalColorWithAlpha(float percentage, float a) {
		return getFloatListFromArray(ColorSchemeFunctionBasedArray.getDecimalVisibleSpectrumWithAlpha(percentage, a));
	}
}